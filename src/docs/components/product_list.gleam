...
import sprocket/html.{button_text, div, div_text, h5_text, img, keyed, li, ul}
      ...
      div(
        ...
        [
          ...
          div(
            ...
            [
              div(
                [class("flex-1 flex-col text-right")],
                [
                  div_text(
              ...
              button_text(
                [
                  class(
                    "text-blue-700 hover:text-blue-800 hover:underline focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-blue-600 dark:hover:text-blue-700 dark:focus:ring-blue-800",
                  ),
                  on_click(on_hide),
                ],
                "Not Interested",
